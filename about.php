...
<section class="about" id="about">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <h3>Game Together. Conquer.</h3>
         <p>Discover, play, and connect with gamers worldwide on GameGroove, the ultimate gaming platform.</p>
         <a href="menu.php" class="btn">our products</a>
      </div>

      <div class="box">
         <img src="images/about-2.png" alt="">
         <h3>Level Up. Dominate.</h3>
         <p>Level up your gaming experience with Gamegroove, the go-to platform for passionate gamers.</p>
         <a href="menu.php" class="btn">our products</a>
      </div>

      <div class="box">
         <img src="images/about-3.png" alt="">
         <h3>Play. Connect. Conquer</h3>
         <p>Embark on thrilling adventures, meet fellow gamers, and dominate the gaming universe on Gamegroove.</p>
         <a href="menu.php" class="btn">Our Products</a>
      </div>
